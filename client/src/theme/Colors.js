...
// Text
export const text      = "#0F1F2E"  // near-black navy for readability

// Accents
export const blue      = "#2F6FDB"  // primary brand blue
export const red       = "#E55353"  // error / warning
export const darkred   = "#C93636"
export const green    = "#2FBF71"  // success
export const grey     = "#9AA9B8"  // secondary text / borders
